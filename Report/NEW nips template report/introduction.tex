...
As table \ref{tab:classes} shows, this selection of emoticons displays positive, negative and neutral emotions.
This data can be split further into extremely positive ( :D ) and extremely negative ( $;($ ) emoticons for more specific classification of messages.
