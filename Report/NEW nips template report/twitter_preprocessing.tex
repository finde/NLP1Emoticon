...
% The message is first split into different components that will help in training.
% In this case, the text, hashtags and emoticons are separated.
% Emoticons in messages are used to add emotion, but not text.
% The text itself can be used to determine whether a message is belongs to a certain class (positive, negative or neutral).
% Therefore, the text without the emoticons can be used to determine which emoticon can be assigned to a certain message.
% Also, the hashtags can be used to further determine the emotion of the message.
% Hashtags often contain extra information, such as 'sad' or 'ecstatic'.
% This can also help determine the emotion of a message.
% In this case, however, the hashtags were not used.
% Therefore, it is important to research the effect of this feature in the future. 
