...
% Does anybody know why doesn't this footnote work? :(
\title{Emoticon Prediction in Text} 

% Does anybody know how to put them in 2 or 4 columns maybe to take less space? :)
\author{ 
Iva Gornishka \\ \texttt{iva.gornishka@student.uva.nl} \AND
...
\noindent The features used in this part of the project correspond to the ones already discussed in section ~\ref{sec:feat}. Note that some features, such as numbers of positive or negative words in hashtags are not applicable in the current setting, since the data does not contain hashtags. Thus, such features have not been considered. 
